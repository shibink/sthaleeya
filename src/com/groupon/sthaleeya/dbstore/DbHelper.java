...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_OSM_TABLE = "create table "
            ...
            + " UNIQUE(name,latitude, longitude) ON CONFLICT IGNORE);";
    ...
    public static final String CREATE_BUSINESS_TIMINGS_TABLE = "create table "
            ...
            + "FOREIGN KEY (merchant_id) REFERENCES " + Constants.MERCHANTS_TABLE
            + "(_id)" + ")";

    public static final String CREATE_INDEX_MERCHANT_ID = "CREATE INDEX id_index ON "
            + Constants.BUSINESS_TIMINGS_TABLE + "(merchant_id)";
    ...
    public void createTables(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_INDEX_MERCHANT_ID);
    }
