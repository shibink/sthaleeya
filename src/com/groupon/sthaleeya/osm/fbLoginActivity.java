...
public class fbLoginActivity extends FacebookActivity {
    ...
    protected void onSessionStateChange(SessionState state, Exception exception) {
        if (state.isOpened()) {
             ...
             * 
             * @Override public void onCompleted(List<GraphUser> users, Response
             * response) { Log.i("fb","inside callback"); ArrayList<String>
             * ids=new ArrayList<String>(); ArrayList<String> friends=new
             * ArrayList<String>(); for(GraphUser user:users){
             * Log.i("fb",user.getId()); ids.add(user.getId());
